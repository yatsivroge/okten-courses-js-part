...
//     let simpsonPhoto = document.createElement('div');
//
//
//
//     divSimpsons.classList.add('member');
//
//     simpsonName.classList.add('simpsonName');
//     simpsonAge.classList.add('simpsonAge');
//     simpsonSurname.classList.add('simpsonSurname');
//     simpsonInfo.classList.add('simpsonInfo');
//     simpsonPhoto.classList.add('simpsonPhoto');
//
//     document.body.appendChild(divSimpsons);
//
//     divSimpsons.appendChild(simpsonName);
//     simpsonName.innerText = simpson.name;
//
//     divSimpsons.appendChild(simpsonAge);
//     simpsonAge.innerText = simpson.age;
//
//     divSimpsons.appendChild(simpsonSurname);
//     simpsonSurname.innerText = simpson.surname;
//
//     divSimpsons.appendChild(simpsonInfo);
//     simpsonInfo.innerText = simpson.info;
//
//     divSimpsons.appendChild(simpsonPhoto);
//     let simpsonImg = document.createElement('img');
//     simpsonPhoto.appendChild(simpsonImg);
...
for (const coursesElement of coursesArray) {
    ...
    let coursesTitle = document.createElement('div');
    courses.appendChild(coursesTitle);
    coursesTitle.innerText = coursesElement.title;


    let coursesmonthDuration = document.createElement('div');
    courses.appendChild(coursesmonthDuration);
    coursesmonthDuration.innerText = coursesElement.monthDuration


    let hourDuration = document.createElement('div');
    courses.appendChild(hourDuration);
    hourDuration.innerText = coursesElement.hourDuration


    let modules = document.createElement('div');
    courses.appendChild(modules);

    let modulesList = document.createElement('ul');
    modules.appendChild(modulesList);

    let modulesListElement = document.createElement('li');
    modulesList.appendChild(modulesListElement);

    let empty = [];
    empty.push(coursesElement.modules);
    for (const emptyElement of empty) {
        modulesListElement.innerText = emptyElement;
    }
}